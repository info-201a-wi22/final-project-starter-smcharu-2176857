...
2. Which cities had the most patients?
...
##**INFORMATIONFROM SUMMARY INFORMATION**

##**OUR TABLE + OBSERVATIONS**


##**CHART 1**:
This chart expresses the amount of allocation funds each state in the United States received during the two periods of distribution which happened in between January 1, 2020, and June 10, 2020. 
...
##CHART 2**:
This chart expresses that the rate of deaths due to COVID-19. The reason why this chart was included was because it shows which states were affected by COVID-19 the most as it shows the death rates comparative to state by state.Through showing the distribution of deaths between all these states, one can compare it to the chart of hospital funds one can connect the dots in why certain states got more money. Hence this graph answers the question of which states were affected the most and also how it affected the allocation of relief funds.
```{r include=FALSE}
source("chart_2.R")
```
...
##**CHART 3**: check this 
This chart is helpful in understanding the trend of hospitalizations in the United States by year. This gives the reader the ability to understand how the trend of hospital rates which is key, especially in the years of 2020 and 2021, in understanding the trends of hospitalizations and seeing have COVID affects hospital occupancy.    
```{r include = FALSE}
source("chart_3.R")
```
