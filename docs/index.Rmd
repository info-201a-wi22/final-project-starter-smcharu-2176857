...
##**CHART 1**:
This chart expresses the amount of allocation funds each state in the United States recieved during the two periods of distribution which happened in between January 1, 2020, and June 10, 2020. 
```{r setup,include = FALSE}
source("chart1.R")
```
##CHART 2**:
